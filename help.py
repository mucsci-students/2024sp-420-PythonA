...
from CustomExceptions import CommandNotFoundError   #if an invalid command was entered after help
...
def cmdHelp(command:str):
    menu = CommandNotFoundError(command)
    ...
    if("class" == command):
        ...
        menu += "just save will save the UML Diagram to its existing file\n"
